...
- Дополнительные нюансы:
  - Коммиты типов `perf`, `refactor`, `docs`, `chore` и т.п. по умолчанию не повышают версию, но могут включаться в changelog в соответствующие разделы. При желании такие типы можно настроить как влияющие на релиз (см. [настройки утилиты](#настройки-утилиты)).
